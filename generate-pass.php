		...
		<div class="form-group caseDetails" style="margin-top:20px;">
			...
			<div class="row" style="margin-top:20px;">
				...
				<div class="row">
					...
					<!-- <div class="col-md-12 DIV_GEN_PASS" style="margin-top:15px; display:none;">
						<label class="control-label col-sm-12" style="text-align:left !important;">
							<input type="checkbox" id="chkmedical"> <span id="idSpanDeclare2">I declare that I have uploaded my vaccination certificate on the website of Rajasthan High Court.</span>
						</label>
					</div> -->
				</div>
				<div class="row">
		...
		<div class="form-group caseDetails">
			<div class="row" style="margin-top:20px;">
				...
				<div class="row">
					...
					<!-- <div class="col-md-12 DIV_GEN_PASS DIV_SECTION_DECLARTION" style="margin-top:15px; display:none;">
						<label class="control-label col-sm-12" style="text-align:left !important;">
							<input type="checkbox" id="chkmedicalsection"> <span id="idSpanDeclare2">I declare that I have uploaded my vaccination certificate on the website of Rajasthan High Court.</span>
						</label>
					</div> -->
				</div>
...
<script type="text/javascript">	
	...
	$('.passfor').on('click', function(){
		...
		// $('#idSpanDeclare2').html(' I declare that I have uploaded my vaccination certificate on the website of Rajasthan High Court.');
		if($.trim($(this).val()) == 'L'){
			$('.LBL_PARTY_TYPE').show();
			$('.DIV_PARTY_TYPE').show();
